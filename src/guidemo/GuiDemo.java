...
public class GuiDemo extends JFrame{
	...
	public GuiDemo() {
		...
		drawPanel.getTextItem().setText(
				...
				"Bugs creep and cause frustration\n" +
				"Debugging brings peace\n"
			);
		drawPanel.getTextItem().setFontSize(42);
		drawPanel.getTextItem().setJustify(TextItem.CENTER);
		drawPanel.setBackgroundImage(Util.getImageResource("/images/earthrise.jpeg"));
    ...
    private class ChooseBackgroundAction extends AbstractAction {
    	...
    	ChooseBackgroundAction(String text) {
    		...
    		if (text.equals("Color...")) {
    			...
    			Graphics2D gra = (Graphics2D) icon.getGraphics();
    			gra.setColor(new Color(123, 144, 144));
    			gra.fill(new Rectangle(32, 32));
    			gra.setColor(Color.RED);
    			gra.fillArc(0, 0, 32, 32, 90, 120);
    			gra.setColor(Color.BLUE);
    			gra.fillArc(0, 0, 32, 32, 210, 120);
    			gra.setColor(Color.GREEN);
    			gra.fillArc(0, 0, 32, 32, 330, 120);
    			gra.setColor(Color.YELLOW);
    			gra.fillArc(6, 6, 20, 20, 30, 120);
    			gra.setColor(new Color(255, 0, 255));
    			gra.fillArc(6, 6, 20, 20, 180, 120);
    			gra.setColor(new Color(0, 255, 255));
    			gra.fillArc(6,  6,  20, 20, 300, 120);
