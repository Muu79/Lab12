...
public class TextMenu extends JMenu {
	...
	private JRadioButton justLeft;
	private JRadioButton justRight;
	private JRadioButton justCenter;
	...
	public TextMenu(DrawPanel owner) {
		...
		JMenu justMenu = new JMenu("Justify");
		ButtonGroup buttGroup = new ButtonGroup();
		justLeft = new JRadioButton("Left");
		justRight = new JRadioButton("Right");
		justCenter = new JRadioButton("Center");
		
		justLeft.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
		...
		justCenter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
		...
		justRight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
		...
		buttGroup.add(justLeft);
		buttGroup.add(justRight);
		buttGroup.add(justCenter);
		justMenu.add(justLeft);
		justMenu.add(justRight);
		justMenu.add(justCenter);
